...
| 작업 | 주기 | 내용 |
|---|---|---|
| **블로그 일일 초안** (`c49cb13870e0`) | 매일 **09:00** | **2026-09-24 일시정지** — Windows 스케줄작업 `AZ2MZ_Blog_Daily`로 이관. `claude -p /blog-daily` 스킬이 10편(티스토리 5+네이버 5, 각각 다른 글) 집필·검증. 발행은 `blog-queue.mjs`가 12:00·15:00·18:00에 담당. |
